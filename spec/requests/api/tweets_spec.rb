...
RSpec.describe "/api/tweets", type: :request do
  ...
  # Api::Tweet. As you add validations to Api::Tweet, be sure to
  ...
  # Api::TweetsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Api::Tweet.create! valid_attributes
  ...
  describe "GET /show" do
    it "renders a successful response" do
      tweet = Api::Tweet.create! valid_attributes
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Api::Tweet" do
        expect {
          post api_tweets_url,
               params: { api_tweet: valid_attributes }, headers: valid_headers, as: :json
        }.to change(Api::Tweet, :count).by(1)
      end
    ...
    context "with invalid parameters" do
      it "does not create a new Api::Tweet" do
        expect {
          post api_tweets_url,
               params: { api_tweet: invalid_attributes }, as: :json
        }.to change(Api::Tweet, :count).by(0)
      end

      it "renders a JSON response with errors for the new api_tweet" do
        post api_tweets_url,
             params: { api_tweet: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested api_tweet" do
        ...
        patch api_tweet_url(tweet),
              params: { api_tweet: new_attributes }, headers: valid_headers, as: :json
        tweet.reload
